package com.wangj.autoscrollviewpagers;
 ...
 */
public class AutoViewPagers extends RelativeLayout implements Handler.Callback {
    ...
    //绘制未选中状态图形
    private LayerDrawable unSelectedLayerDrawable;
    private GradientDrawable unSelectedGradientDrawable;
    //绘制选中状态图形
    private GradientDrawable selectedGradientDrawable;
    private LayerDrawable selectedLayerDrawable;


    private int itemCount = 0;
    private LayoutParams params;

    public AutoViewPagers(Context context) {
        super(context);
        initView();
    }

    public AutoViewPagers(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public AutoViewPagers(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /*设置指示器的方位*/
    public void setIndicatorLocation(int lightRight ,int topBottom ){

        params.addRule(lightRight);
        params.addRule(topBottom);
    }
